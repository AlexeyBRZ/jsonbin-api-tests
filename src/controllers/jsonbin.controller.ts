...
import { collectionId } from "../config/constants";
...
export class JsonbinController {
  ...
  async createHugeBin(data: object) {
    const res = await superagent
      ...
      //   .set("X-Collection-Id", collectionId)
      .send(data);
    return {
      body: res.body,
      status: res.status,
  ...
  async createBinWithWrongCollection(data: object) {
    const res = await superagent
      .post(`${this.baseUrl}/b`)
      .set("Content-Type", "application/json")
      .set("X-Master-Key", this.apiKey)
      .set("X-Bin-Name", "Huge Object")
      .set("X-Collection-Id", "11116c87d0ea881f40a847b7")
      .send(data);
    return {
      body: res.body,
      status: res.status,
  ...
  async putDataToWrongObject(
    ...
    const res1 = await superagent
      ...
      .send(binThatShouldBeUpdatedId);
    const res = await superagent
      .put(`${this.baseUrl}/b/876ba643b1c97be96cded4`)
      .set("Content-Type", "application/json")
      .set("X-Master-Key", this.apiKey)
      .send(newBinObject);
    return {
  ...
  async deleteWithWrongApiKey(data: object) {
    const res1 = await superagent
      .post(`${this.baseUrl}/b`)
      .set("Content-Type", "application/json")
      .set("X-Master-Key", this.apiKey)
  ...
  async deleteObjectWithWrongContentType(data: object) {
    const res1 = await superagent
      .post(`${this.baseUrl}/b`)
      .set("Content-Type", "application/json")
      .set("X-Master-Key", this.apiKey)
  ...
  async deleteObjectThatNotExists(data: object) {
    const res1 = await superagent
      .post(`${this.baseUrl}/b`)
      .set("Content-Type", "application/json")
      .set("X-Master-Key", this.apiKey)
      ...
      .send(data);
    const res = await superagent
      .delete(`${this.baseUrl}/b/876ba643b1c97be96cded4`)
      .set("Content-Type", "application/json")
      .set("X-Master-Key", this.apiKey);
    return {
      body: res.body,
  ...
  async deleteObjectFromCollection(data: object) {
    const res1 = await superagent
      .post(`${this.baseUrl}/b`)
      .set("Content-Type", "application/json")
      .set("X-Master-Key", this.apiKey)
